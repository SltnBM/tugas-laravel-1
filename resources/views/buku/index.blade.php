          ...
          <div class="col-12">
            <div class="card" style="margin-top: 30px;">
              <div class="card-header" style="background-color: blue;">
                <h3 class="card-title" style="color: white;">Data Buku</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="d-flex" style="gap: 10px">
                        <a href="{{ route('buku.show', $value->id) }}" class="btn btn-sm btn-info">
                          Detail
                        </a>
                        <a href="{{ route('buku.edit', $value->id) }}" class="btn btn-sm btn-warning">
                          Edit
                        </a>
                ...
                <a href="{{ route('buku.create') }}" class="btn btn-sm btn-success">
